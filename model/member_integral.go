...
type MemberIntegralLog struct {
	...
	Change     decimal.Decimal                `json:"change" gorm:"column:change;type:decimal(15,4);not NULL;default:0;comment:变动积分;"`     // 变动积分
	...
	Before     decimal.Decimal                `json:"before" gorm:"column:before;type:decimal(15,4);not NULL;default:0;comment:变动前积分;"`    // 变动前积分
	After      decimal.Decimal                `json:"after" gorm:"column:after;type:decimal(15,4);not NULL;default:0;comment:变动后积分;"`      // 变动后积分
...
type MemberIntegralRule struct {
	...
	Rate  decimal.Decimal `json:"rate" gorm:"column:rate;type:decimal(15,4);NULL;default:0;comment:比例;"` // 比例
