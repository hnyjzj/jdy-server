...
type ProductAllocate struct {
	...
	ProductTotalWeightMetal  decimal.Decimal `json:"product_total_weight_metal" gorm:"type:decimal(15,4);not NULL;comment:总金重;"`    // 总金重
	ProductTotalLabelPrice   decimal.Decimal `json:"product_total_label_price" gorm:"type:decimal(10,2);not NULL;comment:总标签价;"`    // 总标签价
	ProductTotalAccessFee    decimal.Decimal `json:"product_total_access_fee" gorm:"type:decimal(10,2);not NULL;comment:总入网费;"`     // 总入网费
	ProductTotalRecyclePrice decimal.Decimal `json:"product_total_recycle_price" gorm:"type:decimal(10,2);not NULL;comment:总回收金额;"` // 总回收金额
