...
func (p *ProductFinished) GetClass() enums.ProductClass {
	// 足金（克
	...
	if (p.RetailType == enums.ProductRetailTypeGoldKg || p.RetailType == enums.ProductRetailTypeGoldPiece) &&
		...
		return enums.ProductClassGoldKg
	}
	...
	if p.RetailType == enums.ProductRetailTypePiece &&
		...
		p.Gem == enums.ProductGemGold {
		return enums.ProductClassGoldPiece
	}
	...
	if p.Material == enums.ProductMaterialGold &&
		...
		p.Gem == enums.ProductGemGold {
		return enums.ProductClassGold750
	}
	...
	if p.Material == enums.ProductMaterialGold &&
		...
		p.Gem == enums.ProductGemGold {
		return enums.ProductClassGold916
	}
	...
	if p.Material == enums.ProductMaterialPlatinum &&
		...
		p.Gem == enums.ProductGemGold {
		return enums.ProductClassPlatinum
	}
	...
	if p.Material == enums.ProductMaterialSilver &&
		...
		p.Gem == enums.ProductGemGold {
		return enums.ProductClassSilver
	}
	...
	if p.Material == enums.ProductMaterialGold &&
		p.Quality == enums.ProductQuality999 &&
		p.Gem != enums.ProductGemGold {
		return enums.ProductClassGoldInlay
	}
	...
	if p.Material == enums.ProductMaterialGem &&
		...
		return enums.ProductClassDiamondNaked
	}
	...
	if (p.Material == enums.ProductMaterialGold || p.Material == enums.ProductMaterialPlatinum) &&
		...
		p.Gem == enums.ProductGemDiamond {
		return enums.ProductClassDiamond
	}
	...
	if p.Material == enums.ProductMaterialGold &&
		...
		return enums.ProductClassCoral
	}
	...
	if p.Material == enums.ProductMaterialGem &&
		...
		return enums.ProductClassPearl
	}
	...
	if p.Material == enums.ProductMaterialGem &&
		...
		return enums.ProductClassJade
	}

	return enums.ProductClassOther
}
