...
type ProductAccessorieWhere struct {
	...
	Price      decimal.Decimal                   `json:"price" label:"单价" find:"false" create:"true" update:"true" sort:"6" type:"decimal" input:"number" required:"true"`                         // 单价
	Remark     string                            `json:"remark" label:"备注" find:"true" create:"true" update:"true" sort:"6" type:"string" input:"textarea" required:"false"`                       // 备注
	Stock      int64                             `json:"stock" label:"库存" find:"false" create:"true" update:"false" sort:"7" type:"int" input:"number" required:"true"`                            // 库存
