...
type ProductAccessorieAllocateWhere struct {
	...
	Method      enums.ProductAllocateMethod `json:"method" label:"调拨类型" input:"select" type:"number" find:"true" create:"true" info:"true" sort:"2" required:"true" preset:"typeMap"`                                                        // 调拨类型
	FromStoreId string                      `json:"from_store_id" label:"调出门店" input:"search" type:"string" find:"false" create:"false" info:"true" sort:"3" required:"false"`                                                               // 调出门店
