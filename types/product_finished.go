...
type ProductFinishedWhere struct {
	...
	EnterTime      time.Time  `json:"enter_time" label:"入库时间" find:"false" sort:"34" type:"data" input:"date"`        // 产品入库时间
	EnterStartTime *time.Time `json:"enter_start_time" label:"入库开始时间" find:"true" sort:"35" type:"data" input:"date"` // 产品入库时间
	EnterEndTime   *time.Time `json:"enter_end_time" label:"入库结束时间" find:"true" sort:"36" type:"data" input:"date"`   // 产品入库时间
}
