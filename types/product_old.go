...
type ProductOldCreateWhere struct {
	...
	WeightMetal             *decimal.Decimal           `json:"weight_metal" label:"金重" find:"true" create:"true" update:"false" sort:"10" type:"number" input:"text" required:"true"`                                       // 金重
	LabelPrice              *decimal.Decimal           `json:"label_price" label:"标签价" find:"true" create:"true" update:"false" sort:"11" type:"number" input:"text" required:"false"`                                      // 标签价
	RecyclePriceGold        *decimal.Decimal           `json:"recycle_price_gold" label:"回收金价" find:"true" create:"true" update:"false" sort:"12" type:"number" input:"text" required:"false"`                              // 回收金价
	RecyclePriceLabor       *decimal.Decimal           `json:"recycle_price_labor" label:"回收工费" find:"true" create:"true" update:"false" sort:"13" type:"number" input:"text" required:"false"`                             // 回收工费
	RecyclePriceLaborMethod enums.ProductRecycleMethod `json:"recycle_price_labor_method" label:"回收工费方式" find:"true" create:"true" update:"false" sort:"14" type:"number" input:"select" required:"false" preset:"typeMap"` // 回收工费方式
	...
	WeightGem               *decimal.Decimal           `json:"weight_gem" label:"主石重" find:"true" create:"true" update:"false" sort:"16" type:"number" input:"text" required:"false"`                                       // 主石重
	...
	WeightOther             *decimal.Decimal           `json:"weight_other" label:"副石重" find:"true" create:"true" update:"false" sort:"21" type:"number" input:"text" required:"false"`                                     // 副石重
	...
	WeightTotal             *decimal.Decimal           `json:"weight_total" label:"总重" find:"true" create:"true" update:"false" sort:"23" type:"number" input:"text" required:"false"`                                      // 总重
	QualityActual           *decimal.Decimal           `json:"quality_actual" label:"实际成色" find:"true" create:"true" update:"false" sort:"24" type:"number" input:"text" required:"true"`                                   // 实际成色
