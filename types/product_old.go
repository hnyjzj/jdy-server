...
type ProductOldWhere struct {
	...
	LabelPrice  *decimal.Decimal      `json:"label_price" label:"标签价" find:"true" create:"true" update:"false" sort:"12" type:"number" input:"number" required:"false"`               // 标签价
	...
	WeightMetal *decimal.Decimal      `json:"weight_metal" label:"金重" find:"true" create:"true" update:"false" sort:"11" type:"number" input:"number" required:"true"`                // 金重
	WeightTotal *decimal.Decimal      `json:"weight_total" label:"总重" find:"true" create:"true" update:"false" sort:"24" type:"number" input:"number" required:"false"`               // 总重
	...
	WeightGem   *decimal.Decimal      `json:"weight_gem" label:"主石重" find:"true" create:"true" update:"false" sort:"17" type:"number" input:"number" required:"false"`                // 主石重
	...
	WeightOther *decimal.Decimal      `json:"weight_other" label:"副石重" find:"true" create:"true" update:"false" sort:"22" type:"number" input:"number" required:"false"`              // 副石重
	...
	RecyclePrice            *decimal.Decimal           `json:"recycle_price" label:"回收金额" find:"true" create:"true" update:"false" sort:"27" type:"number" input:"number" required:"false"`                                 // 回收金额
	RecyclePriceGold        *decimal.Decimal           `json:"recycle_price_gold" label:"回收金价" find:"true" create:"true" update:"false" sort:"13" type:"number" input:"number" required:"false"`                            // 回收金价
	RecyclePriceLabor       *decimal.Decimal           `json:"recycle_price_labor" label:"回收工费" find:"true" create:"true" update:"false" sort:"15" type:"number" input:"number" required:"false"`                           // 回收工费
	...
	QualityActual           *decimal.Decimal           `json:"quality_actual" label:"实际成色" find:"true" create:"true" update:"false" sort:"25" type:"number" input:"number" required:"true"`                                 // 实际成色
...
type ProductOldCreateWhere struct {
	...
	Quality                 enums.ProductQuality       `json:"quality" label:"成色" find:"true" create:"true" update:"false" sort:"6" type:"number" input:"select" required:"true" preset:"typeMap"`                          // 成色
	Gem                     enums.ProductGem           `json:"gem" label:"主石" find:"true" create:"true" update:"false" sort:"7" type:"number" input:"select" required:"true" preset:"typeMap"`                              // 主石
	Category                enums.ProductCategory      `json:"category" label:"品类" find:"true" create:"true" update:"false" sort:"8" type:"number" input:"select" required:"false" preset:"typeMap"`                        // 品类
	Craft                   enums.ProductCraft         `json:"craft" label:"工艺" find:"true" create:"true" update:"false" sort:"9" type:"number" input:"select" required:"false" preset:"typeMap"`                           // 工艺
	WeightMetal             *decimal.Decimal           `json:"weight_metal" label:"金重" find:"true" create:"true" update:"false" sort:"10" type:"number" input:"number" required:"true"`                                     // 金重
	LabelPrice              *decimal.Decimal           `json:"label_price" label:"标签价" find:"true" create:"true" update:"false" sort:"11" type:"number" input:"number" required:"false"`                                    // 标签价
	RecyclePriceGold        *decimal.Decimal           `json:"recycle_price_gold" label:"回收金价" find:"true" create:"true" update:"false" sort:"12" type:"number" input:"number" required:"false"`                            // 回收金价
	RecyclePriceLabor       *decimal.Decimal           `json:"recycle_price_labor" label:"回收工费" find:"true" create:"true" update:"false" sort:"13" type:"number" input:"number" required:"false"`                           // 回收工费
	RecyclePriceLaborMethod enums.ProductRecycleMethod `json:"recycle_price_labor_method" label:"回收工费方式" find:"true" create:"true" update:"false" sort:"14" type:"number" input:"select" required:"false" preset:"typeMap"` // 回收工费方式
	Brand                   enums.ProductBrand         `json:"brand" label:"品牌" find:"true" create:"true" update:"false" sort:"15" type:"number" input:"select" required:"false" preset:"typeMap"`                          // 品牌
	WeightGem               *decimal.Decimal           `json:"weight_gem" label:"主石重" find:"true" create:"true" update:"false" sort:"16" type:"number" input:"number" required:"false"`                                     // 主石重
	ColorGem                enums.ProductColor         `json:"color_gem" label:"主石颜色" find:"true" create:"true" update:"false" sort:"17" type:"number" input:"select" required:"false" preset:"typeMap"`                    // 主石颜色
	Clarity                 enums.ProductClarity       `json:"clarity" label:"主石净度" find:"true" create:"true" update:"false" sort:"18" type:"number" input:"select" required:"false" preset:"typeMap"`                      // 主石净度
	Cut                     enums.ProductCut           `json:"cut" label:"主石切工" find:"true" create:"true" update:"false" sort:"19" type:"number" input:"select" required:"false" preset:"typeMap"`                          // 主石切工
	NumGem                  int                        `json:"num_gem" label:"主石数量" find:"true" create:"true" update:"false" sort:"20" type:"number" input:"number" required:"false"`                                       // 主石数量
	WeightOther             *decimal.Decimal           `json:"weight_other" label:"副石重" find:"true" create:"true" update:"false" sort:"21" type:"number" input:"number" required:"false"`                                   // 副石重
	NumOther                int                        `json:"num_other" label:"副石数" find:"true" create:"true" update:"false" sort:"22" type:"number" input:"number" required:"false"`                                      // 副石数
	WeightTotal             *decimal.Decimal           `json:"weight_total" label:"总重" find:"true" create:"true" update:"false" sort:"23" type:"number" input:"number" required:"false"`                                    // 总重
	QualityActual           *decimal.Decimal           `json:"quality_actual" label:"实际成色" find:"true" create:"true" update:"false" sort:"24" type:"number" input:"number" required:"true"`                                 // 实际成色
	...
	RecyclePrice            *decimal.Decimal           `json:"recycle_price" label:"回收金额" find:"true" create:"true" update:"false" sort:"27" type:"number" input:"number" required:"false"`                                 // 回收金额
	StoreId                 string                     `json:"store_id" label:"所属店铺" find:"false" create:"true" update:"false" sort:"30" type:"string" input:"text" required:"false"`                                       // 所属店铺
}
