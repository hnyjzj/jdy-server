...
type StaffWhere struct {
	Username   string       `json:"username" label:"用户名" find:"true" create:"true" sort:"1" type:"string" input:"text"`
	Phone      string       `json:"phone" label:"手机号" find:"true" create:"true" sort:"2" type:"string" input:"text"`
	Nickname   string       `json:"nickname" label:"姓名" find:"true" sort:"3" type:"string" input:"text"`
	Email      string       `json:"email" label:"邮箱" find:"true" sort:"3" type:"string" input:"text"`
